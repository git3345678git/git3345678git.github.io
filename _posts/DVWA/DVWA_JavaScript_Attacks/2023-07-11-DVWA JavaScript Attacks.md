---
layout: post
title: "DVWA JavaScript Attacks"
description: ""
date: 2023-07-11
categories:
  - DVWA
  - DVWA_JavaScript_Attacks
author: ""
tags: ['DVWA', 'JavaScript_Attacks']
---
...
他生成token 的方式就是，把input value 產生。

用google console 測試一下
```
md5(rot13("ChangeMe"));
...
setTimeout -> do_elsesomething("XX") 

//假設輸入success
"XXsuccessXX"

//反轉
do_something("XXsuccessXX")
XXsseccusXX

XXsseccusXX 就是最後的 token 
...
//token_part_2("XX")，但有延遲
setTimeout(function() {
    token_part_2("XX")
}, 300);

//send 按鈕 按下會觸發 token_part_3()
document.getElementById("send").addEventListener("click", token_part_3);
...
順序是 token_part_1 -> token_part_2 提交觸發 token_part_3
